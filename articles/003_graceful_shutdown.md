...
topics: ["Go", "Troubleshooting", "gRPC", "CloudSQL", "CloudRun"]
published: true
canonical: "https://qiita.com/horirinn2000/items/1fd060d5dbe1ae3f38e5"
---
...
Cloud Runのようなサーバーレス環境では「コンテナは使い捨て」という意識が強いですが、使い終わった後の後始末（Graceful Shutdown）をしっかり行わないと、DBなどのバックエンドリソースを食いつぶしてしまうことがあります。
...
※ この記事は [Qiita](https://qiita.com/horirinn2000/items/1fd060d5dbe1ae3f38e5) に投稿した内容を転載したものです。